...
export const ko: Dict = {
  ...
  'review.stage.beats': '흐름 검수',
  'review.stage.stills': '이미지 검수',
  'review.stage.clips': '영상 생성',
  'review.stage.done': '완료',
  'review.segmentN': '{n}번 구간 · {from}–{to}',
  'review.empty': '(비어 있음)',
  'review.noSegments': '아직 구간이 없어요. 흐름부터 짜볼까요.',
  ...
  'review.needImage': '아직 이미지가 없어요 — 아래의 [이미지 생성]을 눌러주세요.',
  'review.needClip': '아직 클립이 없어요 — 아래의 [영상 렌더 시작]을 눌러주세요.',
  'review.busyNote': '이 화면을 나가도 작업은 계속돼요 — 끝나면 알림함으로 알려드릴게요.',
  'review.tip.0': '진행 중입니다…',
  ...
  'create.formatQuestion': '무엇을 만드시나요?',
  'create.lengthQuestion': '길이는 얼마나 할까요?',
  'create.format.shorts': '숏츠',
  'create.format.shorts.hint': '세로 9:16, 1분 이내 — 유튜브 숏츠, 릴스, 틱톡.',
  'create.format.film': '영화',
  'create.format.film.hint': '와이드 16:9, 1분에서 1시간까지. mayo가 잘하는 장편.',
  'create.format.square': '정방형',
